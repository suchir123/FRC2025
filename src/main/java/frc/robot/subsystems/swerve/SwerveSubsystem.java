...
//                 .createSwerveDrive(Constants.DriveConstants.MAX_SPEED,
//                     new Pose2d(
...
//         //   System.out.println(module.getConfiguration().angleOffset);
//         //   System.out.println("Setting it....");
//         //   module.getAbsoluteEncoder().setAbsoluteEncoderOffset(module.getConfiguration().angleOffset);
//         // }
...
//     private SwerveModuleState getAbsoluteSwerveModuleState(SwerveModule module) {
//         Rotation2d angle = Rotation2d.fromDegrees(module.getRawAbsolutePosition());
//         double velocity = module.getDriveMotor().getVelocity();
//         return new SwerveModuleState(velocity, angle);
//     }

//     private SwerveModuleState getRelativeSwerveModuleState(SwerveModule module) {
//         Rotation2d angle = Rotation2d.fromDegrees(module.getRelativePosition());
//         double velocity = module.getDriveMotor().getVelocity();
//         return new SwerveModuleState(velocity, angle);
//     }
...
//         SwerveModule frontLeft = modules[0];
//         SwerveModule frontRight = modules[1];
//         SwerveModule backLeft = modules[2];
//         SwerveModule backRight = modules[3];

//         // if (frontLeft.getAngleMotor() instanceof SparkMaxSwerve
//         //     || frontLeft.getAngleMotor() instanceof SparkMaxBrushedMotorSwerve) {
//         //   if (frontLeft.getAbsoluteEncoder() instanceof SparkMaxEncoderSwerve) {
//         //     System.out.println("did get the thingy worked, the motor yeah");
//         //   } else {
//         //     System.out.println("did no (encoder wrong bad SparkMaxEncoderSwerve!!)");
//         //   }
//         // } else {
//         //   System.out.println("did no (motor wrong bad SparkMaxSwerve)");
//         // }

//         // System.out.println(frontLeft.getAbsolutePosition());
//         // System.out.println("Absolute absolute front left: " + ((CANCoderSwerve)frontLeft.getAbsoluteEncoder()).encoder.getAbsolutePosition().getValueAsDouble());

//         //
//         realSwerveStatePublisher.set(new SwerveModuleState[]{
//                 getAbsoluteSwerveModuleState(frontLeft),
//                 getAbsoluteSwerveModuleState(frontRight),
//                 getAbsoluteSwerveModuleState(backLeft),
//                 getAbsoluteSwerveModuleState(backRight),
//         });

//         //
//         relativeSwerveStatePublisher.set(new SwerveModuleState[]{
//                 getRelativeSwerveModuleState(frontLeft),
//                 getRelativeSwerveModuleState(frontRight),
//                 getRelativeSwerveModuleState(backLeft),
//                 getRelativeSwerveModuleState(backRight),
//         });

//         //posts robot position to network table
//         posePositionPublisher.set(this.getPose());
//         robotRotationPublisher.set(this.swerveDrive.getGyro().getRotation3d().toRotation2d());
//     }
