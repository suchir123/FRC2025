...
//     //private static final double c_camTranslation = DriveTrainSubsystemOld.cameraLocation.getDistance(new Translation2d());
//     //private static final double thi_camTranslation = Math.asin(DriveTrainSubsystemOld.cameraLocation.getY() / c_camTranslation);
